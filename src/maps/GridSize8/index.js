...
export default function GridSize8({onCellClick, getCellContent, colorMotion, map}) {
    ...
    return (
        <div style={{marginLeft: 6}} > { /* */}
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={6} column={3} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                ...
                <GameCell row={6} column={6} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
