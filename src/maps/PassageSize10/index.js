...
export default function Message({onCellClick, getCellContent, colorMotion, map}) {
    ...
    const cellSize = (document.documentElement.clientWidth - 20 - 12) / 10 // (ширина - отступы по бокам - (кол-во ячеек в ряду * 2)) / кол-во ячеек
    ...
    return (
        <div style={{marginLeft: 6}} > { /* */}
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={1} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={1} column={6} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={2} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={2} column={6} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={3} column={3} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={3} column={4} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={3} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={3} column={6} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={3} column={7} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={3} column={8} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={4} column={3} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={4} column={4} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                ...
                <GameCell row={4} column={7} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={4} column={8} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={7} column={3} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={7} column={4} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                ...
                <GameCell row={7} column={7} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={7} column={8} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={8} column={3} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={8} column={4} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={8} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={8} column={6} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={8} column={7} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={8} column={8} disabled={false} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={9} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={9} column={6} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={10} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={10} column={6} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
