...
export default function Message({onCellClick, getCellContent, colorMotion, map, lastMotionCoords}) {
    ...
    const cellSize = (Math.min(document.documentElement.clientWidth, 500) - 18 - 12) / 9 // (ширина - отступы по бокам - (кол-во ячеек в ряду * 2)) / кол-во ячеек
    ...
    return (
        <div style={{marginLeft: 6}} > { /* */}
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={4} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} lastMotionCoords={lastMotionCoords} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={5} column={3} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} lastMotionCoords={lastMotionCoords} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={5} column={4} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} lastMotionCoords={lastMotionCoords} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={5} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} lastMotionCoords={lastMotionCoords} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={5} column={6} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} lastMotionCoords={lastMotionCoords} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={5} column={7} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} lastMotionCoords={lastMotionCoords} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={6} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} lastMotionCoords={lastMotionCoords} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={7} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} lastMotionCoords={lastMotionCoords} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
