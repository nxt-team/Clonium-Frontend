    ...
    return (
        <div style={{marginLeft: 6}} > { /* */}
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={4} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
            ...
            <div style={{ display: 'flex' }}>
                ...
                <GameCell row={5} column={4} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
                <GameCell row={5} column={5} disabled={true} cellStyle={cellStyle} colorMotion={colorMotion} map={map} getCellContent={getCellContent} onCellClick={onCellClick}/>
